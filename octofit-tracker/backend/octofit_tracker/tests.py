...
class ActivityModelTest(TestCase):
    def test_create_activity(self):
        ...
        activity = Activity.objects.create(user=user, activity_type='run', duration=30, date='2025-06-13')
...
class WorkoutModelTest(TestCase):
    def test_create_workout(self):
        ...
        workout = Workout.objects.create(user=user, workout_type='yoga', duration=45, date='2025-06-13')
